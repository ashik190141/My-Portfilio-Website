        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-center">
          ...
          <div className="p-2 md:p-0">
            ...
            <p className="text-white text-xl text-justify font-sans mb-10">
              I am a highly motivated, hard worker and progress-focused web
              developer. I am try to learn and explore new technologies all
              time. Skilled in creating responsive user interfaces and building
              RESTful APIs.
            </p>
            <div>
              <a
